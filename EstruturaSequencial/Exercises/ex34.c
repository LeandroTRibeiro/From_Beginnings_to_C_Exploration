...
34. Elabore um algoritmo que leia o salário-base de um funcionário, calcule e mostre o seu salário a 
...
int main() {
    ...
    do {
        ...
        if(
            ...
            workers[workersLength].finalSalary = workers[workersLength].salary + workers[workersLength].salaryIncreaseInReal;
        ...
        workers[workersLength].finalSalary = (workers[workersLength].finalSalary * workers[workersLength].INSS) / 100;
