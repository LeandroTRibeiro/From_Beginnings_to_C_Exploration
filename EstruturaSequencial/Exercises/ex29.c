...
float averageReduce(float grades[], float gradesWeigth[], int size);
    ...
    do {
        ...
        do {
            ...
            for(int i = 0; i < semesterReviews; i++) {
                ...
                printf("\nDigite o peso da %da avaliacao: ", i+1);
                scanf(" %f", &students[studentLength].diciplines[diciplineLength].gradesWeigth[i]);
            };
            ...
            students[studentLength].diciplines[diciplineLength].finalGrade = averageReduce(students[studentLength].diciplines[diciplineLength].grades, students[studentLength].diciplines[diciplineLength].gradesWeigth, semesterReviews);
        ...
        for(int student = 0; student < studentLength; student++) {
            ...
            for(int dicipline = 0; dicipline <= students[student].diciplinesLenght; dicipline++) {
                ...
                for(int review = 0; review < semesterReviews; review++) {
                    printf("\n%da avaliacao: %.2f peso: %.2f", review + 1, students[student].diciplines[dicipline].grades[review], students[student].diciplines[dicipline].gradesWeigth[review]);
                };
...
float averageReduce(float grades[], float gradesWeigth[], int size) {
    ...
    for(int i = 0; i < size; i++) {
        gradeSum += grades[i] * gradesWeigth[i];
        weightSum += gradesWeigth[i];    
    };
